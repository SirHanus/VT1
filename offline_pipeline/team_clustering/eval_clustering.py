...
def parse_args() -> argparse.Namespace:
    ...
    mdl.add_argument("--team-models", type=str, default=str(local_base / "clustering"),
                     help="Folder with umap.pkl and kmeans.pkl")
    mdl.add_argument("--siglip", type=str, default="google/siglip-base-patch16-224", help="SigLIP model id")
    mdl.add_argument("--yolo-model", type=str, default=str(root / "yolo11n.pt"), help="YOLO detection model path/id")
    ...
    out.add_argument("--out-dir", type=str, default=str(local_base / "outputs"), help="Output directory root")
