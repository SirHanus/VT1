...
class PipelineTab(QtWidgets.QWidget):
    ...
    def _fill_defaults(self):
        ...
        self.ed_pose_model.setText(str(root / "hockeypose_1" / "yolo11x-pose.pt"))
        ...
        self.ed_team_models.setText(str(root / "offline_pipeline" / "team_clustering" / "clustering"))
    ...
    def _on_run(self):
        ...
        script = str(Path(__file__).resolve().parent / "sam_offline.py")
    ...
    def _build_args(self) -> list[str]:
        ...
        if self.sb_max_frames.value() > 0: add("--max-frames", str(self.sb_max_frames.value()))
